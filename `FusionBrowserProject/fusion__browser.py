...
# --- العنوان العالمي الجديد لخادم البحث الخاص بك ---
SEARCH_ENGINE_URL = "https://fusionbrowser.onrender.com"
...
class WebBrowser(QMainWindow):
    def __init__(self):
        ...
        # --- تم التعديل هنا ---
        add_tab_btn.clicked.connect(lambda: self.add_new_tab(QUrl(SEARCH_ENGINE_URL)))
        ...
        # --- تم التعديل هنا ---
        self.add_new_tab(QUrl(SEARCH_ENGINE_URL), "Fusion Search")
    ...
    def navigate_to_url(self):
        ...
        if '.' in url_text and ' ' not in url_text:
            ...
            # --- تم التعديل هنا ---
            qurl = QUrl(f"{SEARCH_ENGINE_URL}/search?q={search_term}")
    ...
    def go_to_home(self):
        # --- تم التعديل هنا ---
        self.active_browser().setUrl(QUrl(SEARCH_ENGINE_URL))
